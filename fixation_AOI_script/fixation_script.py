...
df_fixation = pd.read_csv("subject14_pinwheel_fixations.csv")
df_task_aoi = pd.read_csv("subject14_pinwheel_step_unix.csv")
df_task_aoi = df_task_aoi.drop_duplicates()
...
# df_task_aoi.rename(columns={'Step Number': 'step_number'})
if "Unnamed: 0" in df_task_aoi:
    df_task_aoi.pop("Unnamed: 0")
